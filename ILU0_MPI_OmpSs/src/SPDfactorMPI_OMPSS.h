...
extern ptr_ILU0Factor InitILU0FactorizationMPIOMPSS (SparseMatrix spr, int index, int nleaves,
...
extern int ILU0FactorizationMPIOMPSS (SparseMatrix spr, int index, int nleaves, paramFactor parFac, 
