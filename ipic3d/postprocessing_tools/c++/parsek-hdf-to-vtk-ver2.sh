...
# Version 2
#
# In version 2, the code works with HDF5 versions 1.6.5 to 1.6.7. Higher HDF5 versions are supported in version 3.
#
...
INCLUDE_HDF5_PATH="-I/shared/hdf5/include/"
LIBRARY_HDF5_PATH="-L/shared/hdf5/lib/"
...
echo "  dataset_id = H5Dopen(file_id, \"/topology/Nprocs\");                                              " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/topology/XLEN\");                                                " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/topology/YLEN\");                                                " >> ${ConverterFileName}
...
if [ ${Dimension} = "3D" ];then
   ...
   echo "  dataset_id = H5Dopen(file_id, \"/topology/ZLEN\");                                             " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/collective/Lx\");                                                " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/collective/Ly\");                                                " >> ${ConverterFileName}
...
if [ ${Dimension} = "3D" ];then
   ...
   echo "  dataset_id = H5Dopen(file_id, \"/collective/Lz\");                                             " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/collective/Nxc\");                                               " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/collective/Nyc\");                                               " >> ${ConverterFileName}
...
if [ ${Dimension} = "3D" ];then
   ...
   echo "  dataset_id = H5Dopen(file_id, \"/collective/Nzc\");                                            " >> ${ConverterFileName}
...
echo "  dataset_id = H5Dopen(file_id, \"/collective/Ns\");                                                " >> ${ConverterFileName}
...
echo "      dataset_id = H5Dopen(proc_file_id[i], \"/topology/cartesian_coord\");                         " >> ${ConverterFileName}
...
for icount in ${Var_List_Read[@]}; do
    ...
    if [ ${Dimension} = "2D" ];then
       ...
       echo "            dataset_id = H5Dopen(proc_file_id[mappa[i][j]],temp.c_str());                       " >> ${ConverterFileName}
    fi
    if [ ${Dimension} = "3D" ];then
       echo "                                                                                                " >> ${ConverterFileName}
       echo "            // open file for new data set to read                                               " >> ${ConverterFileName}
       ...
       echo "            }                                                                                   " >> ${ConverterFileName}
       echo "            temp = \"/${Var_List_Read[$i]}/cycle_\"+ cc.str();                                  " >> ${ConverterFileName}
       echo "            dataset_id = H5Dopen(proc_file_id[mappa[i][j][k]],temp.c_str());                    " >> ${ConverterFileName}
    fi
