...
Input_Data_Folder="/home/alexander/Desktop/data/tred46/output-data-block-single-var-${TR1_coord}${TR1}${TR2_coord}${TR2}"
Output_Plot_Folder="."
Gnuplot_Script_name="plot-virt-sat-block-single-var.gnuplot"
...
# plot title
multiplot_title="Virt.Sat. Trace Data at ${TR1_coord}=${TR1}, ${TR2_coord}=${TR2} tred46"
font="Helvetica,20"
