...
/***************************************************************************
    ...
    process-virtual-sat.cpp  -  postprocessing program to extract data from VirtualSatellites* files from Parsek2D
...
////////////////////////////////////////////////////////////////////////
// Function 'find_virtual_sat_block' finds the best satellite match with closest position to user given (x,y) spatial coordinates.
...
void find_virtual_sat_block(float x_satellite_user,
   ...
   desired_sat_coordinates[0]=closest_sat_coordinates[0];
    ...
    for (i=0;i<iSatCount;i++){
        ...
        cout << "---> Desired " << XY_block << " Sat. Coordinates " << original_desired_sat_coordinates0 << endl ;
        cout << "---> Closest " << XY_block << " Sat. Coordinates " << closest_sat_coordinates[0] << endl ;
        cout << "---> Closest " << XY_block << " Vector Difference " << closest_vector_difference[0] << endl ;
...
int main()
{
    ...
    // find the trace of virtual satellites which is closest to our specified (XY_block) line
